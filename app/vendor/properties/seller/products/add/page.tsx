      ...
      !needsVariants ? (
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData((p) => ({ ...p, rentalQuantity: Math.max(0, Number(e.target.value) || 0) }))
            }
            className="w-full border px-3 py-2 rounded"
          />
        ...
        <p className="text-sm text-gray-600">
          Rental availability will be calculated from variant stock.
        </p>
      )
    )}
  </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  const sellerPrice = Number(e.target.value) || 0;
                  setFormData((p) => ({
                    ...p,
                    sellerBasePrice: sellerPrice,
                  }));
                }}
                className="w-full border px-3 py-2 rounded"
              />
        ...
        { formData.listingType === "rent" && (
          ...
          <>
            <div>
              <label className="block text-sm font-medium mb-1">Your Rent Price / Day (₹)</label>
              <input
                type="number"
                min="0"
                value={formData.sellerRentPriceDay}
                onChange={(e) => {
                  const sellerRentPrice = Number(e.target.value) || 0;
                  setFormData((p) => ({
                    ...p,
                    sellerRentPriceDay: sellerRentPrice,
                  }));
                }}
                className="w-full border px-3 py-2 rounded"
              />
              {errors.sellerRentPriceDay && (
                <p className="text-red-600 text-sm mt-1">{errors.sellerRentPriceDay}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData((p) => ({ ...p, rentalStartDate: e.target.value }))}
                  className="w-full border px-3 py-2 rounded"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData((p) => ({ ...p, rentalEndDate: e.target.value }))}
                  className="w-full border px-3 py-2 rounded"
                />
